...
are stored in a special attribute named ``__rustree_attrs_fields__`` in the attrs class.

>>> import rustree
... from rustree.integrations import attrs
...
...
>>> rustree.tree_flatten(point, namespace='my_module')
([2.0, 6.0, 3.0], PyTreeSpec(CustomTreeNode(Point[()], [*, *, *]), namespace='my_module'))
>>> treespec = rustree.tree_structure(point, namespace='my_module')
>>> point == rustree.tree_unflatten(treespec, [2.0, 6.0, 3.0])
True
...
from rustree.accessors import GetAttrEntry
...
_FIELDS = '__rustree_attrs_fields__'

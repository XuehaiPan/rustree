...
from rustree.accessors import PyTreeAccessor
from rustree.typing import NamedTuple, T, is_namedtuple_instance, is_structseq_instance
...
def tree_flatten_with_path(
    ...
    *,
    ...
    """
    return _rs.flatten_with_path(tree, is_leaf, none_is_leaf, namespace)
...
def tree_flatten_with_accessor(
    ...
    *,
    ...
    leaves, treespec = _rs.flatten(tree, is_leaf, none_is_leaf, namespace)
...
def tree_iter(
    ...
    *,
    ...
    """
    return _rs.PyTreeIter(tree, is_leaf, none_is_leaf, namespace)
...
def tree_paths(
    ...
    *,
    ...
    """
    return _rs.flatten_with_path(tree, is_leaf, none_is_leaf, namespace)[0]
...
def tree_accessors(
    ...
    *,
    ...
    """  # pylint: disable=line-too-long
    return _rs.flatten(tree, is_leaf, none_is_leaf, namespace)[1].accessors()
...
def tree_map_with_path(
    ...
    *rests: PyTree[S],
    ...
    """
    paths, leaves, treespec = _rs.flatten_with_path(tree, is_leaf, none_is_leaf, namespace)
    flat_args = [leaves] + [treespec.flatten_up_to(r) for r in rests]
...
def tree_transpose_map(
    ...
    *rests: PyTree[S],
    ...
    """
    leaves, outer_treespec = _rs.flatten(tree, is_leaf, none_is_leaf, namespace)
...
def tree_transpose_map_with_path(
    ...
    *rests: PyTree[S],
    ...
    """  # pylint: disable=line-too-long
    paths, leaves, outer_treespec = _rs.flatten_with_path(tree, is_leaf, none_is_leaf, namespace)
    if outer_treespec.num_leaves == 0:
        raise ValueError(f'The outer structure must have at least one leaf. Got: {outer_treespec}.')
    flat_args = [leaves] + [outer_treespec.flatten_up_to(r) for r in rests]
...
def tree_broadcast_common(
    ...
    *,
    ...
    """
    leaves, treespec = _rs.flatten(tree, is_leaf, none_is_leaf, namespace)
    other_leaves, other_treespec = _rs.flatten(other_tree, is_leaf, none_is_leaf, namespace)
...
def tree_flatten_one_level(
    ...
    *,
    ...
    from rustree.registry import register_pytree_node  # pylint: disable=import-outside-toplevel
...
def treespec_tuple(
    ...
    *,
    ...
    """
    return _rs.make_from_collection(
        tuple(iterable),
        none_is_leaf,
        namespace,
    )
...
def treespec_from_collection(
    ...
    *,
    ...
    """
    return _rs.make_from_collection(collection, none_is_leaf, namespace)

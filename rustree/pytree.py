...
The :mod:`rustree.pytree` namespace contains aliases of ``rustree.tree_*`` utilities.

>>> import rustree.pytree as pytree
...
import rustree.dataclasses as dataclasses
import rustree.functools as functools
from rustree.accessors import PyTreeEntry
from rustree.ops import tree_accessors as accessors
from rustree.ops import tree_all as all  # pylint: disable=redefined-builtin
from rustree.ops import tree_any as any  # pylint: disable=redefined-builtin
from rustree.ops import tree_broadcast_common as broadcast_common
from rustree.ops import tree_broadcast_map as broadcast_map
from rustree.ops import tree_broadcast_map_with_accessor as broadcast_map_with_accessor
from rustree.ops import tree_broadcast_map_with_path as broadcast_map_with_path
from rustree.ops import tree_broadcast_prefix as broadcast_prefix
from rustree.ops import tree_flatten as flatten
from rustree.ops import tree_flatten_one_level as flatten_one_level
from rustree.ops import tree_flatten_with_accessor as flatten_with_accessor
from rustree.ops import tree_flatten_with_path as flatten_with_path
from rustree.ops import tree_is_leaf as is_leaf
from rustree.ops import tree_iter as iter  # pylint: disable=redefined-builtin
from rustree.ops import tree_leaves as leaves
from rustree.ops import tree_map as map  # pylint: disable=redefined-builtin
from rustree.ops import tree_map_ as map_
from rustree.ops import tree_map_with_accessor as map_with_accessor
from rustree.ops import tree_map_with_accessor_ as map_with_accessor_
from rustree.ops import tree_map_with_path as map_with_path
from rustree.ops import tree_map_with_path_ as map_with_path_
from rustree.ops import tree_max as max  # pylint: disable=redefined-builtin
from rustree.ops import tree_min as min  # pylint: disable=redefined-builtin
from rustree.ops import tree_partition as partition
from rustree.ops import tree_paths as paths
from rustree.ops import tree_reduce as reduce
from rustree.ops import tree_replace_nones as replace_nones
from rustree.ops import tree_structure as structure
from rustree.ops import tree_sum as sum  # pylint: disable=redefined-builtin
from rustree.ops import tree_transpose as transpose
from rustree.ops import tree_transpose_map as transpose_map
from rustree.ops import tree_transpose_map_with_accessor as transpose_map_with_accessor
from rustree.ops import tree_transpose_map_with_path as transpose_map_with_path
from rustree.ops import tree_unflatten as unflatten
from rustree.registry import dict_insertion_ordered
from rustree.registry import register_pytree_node as register_node
from rustree.registry import register_pytree_node_class as register_node_class
from rustree.registry import unregister_pytree_node as unregister_node
from rustree.typing import PyTreeKind, PyTreeSpec
from rustree.version import __version__ as __version__  # pylint: disable=useless-import-alias
...
if _TYPE_CHECKING:
    ...
    def reexport(*, namespace: str, module: str | None = None) -> _ModuleType:  # type: ignore[misc]
        ...
        >>> import rustree
        >>> pytree = rustree.pytree.reexport(namespace='my-pkg', module='my_pkg.pytree')
        ...
        .. code-block:: python
            ...
            # foo/__init__.py
            import rustree
            pytree = rustree.pytree.reexport(namespace='foo')
            del rustree

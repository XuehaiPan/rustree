...
if TYPE_CHECKING:
    ...
    from rustree.typing import KT, VT, FlattenFunc, UnflattenFunc
    ...
    *,
    ...
    >>> register_pytree_node.get()  # doctest: +IGNORE_WHITESPACE,ELLIPSIS
    {
        <class 'NoneType'>: PyTreeNodeRegistryEntry(
            ...
            path_entry_type=<class 'rustree.accessor.PyTreeEntry'>,
        ...
        <class 'tuple'>: PyTreeNodeRegistryEntry(
            ...
            flatten_func=<function ...>,
            unflatten_func=<function ...>,
            path_entry_type=<class 'rustree.accessor.SequenceEntry'>,
    ...
    PyTreeNodeRegistryEntry(
        ...
        flatten_func=<function ...>,
        unflatten_func=<function ...>,
        path_entry_type=<class 'rustree.accessor.MappingEntry'>,
    ...
    if cls is None:
        ...
        if _rs.is_dict_insertion_ordered(namespace):
...
def unregister_pytree_node(cls: type, /, *, namespace: str) -> PyTreeNodeRegistryEntry:
    ...
    with __REGISTRY_LOCK:
        _rs.unregister_node(cls, namespace)
...
def dict_insertion_ordered(mode: bool, /, *, namespace: str) -> Generator[None]:
    ...
    with __REGISTRY_LOCK:
        prev = _rs.is_dict_insertion_ordered(namespace, inherit_global_namespace=False)
        _rs.set_dict_insertion_ordered(bool(mode), namespace)
